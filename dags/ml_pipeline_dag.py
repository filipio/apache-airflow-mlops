...
def prepare_data_task():
    ...
    businesses = pd.read_json("/mnt/shared/yelp_academic_dataset_business.json", lines=True, orient='columns', chunksize=1000000, encoding='utf8')
    ...
    reviews = pd.read_json("/mnt/shared/yelp_academic_dataset_review.json", lines=True, orient='columns', chunksize=1000000, encoding='utf8')
